...
public class ArrangeKeyboard implements Movable {
    ...
    private void moveLeft() {
        if (shipTaken) {
            if (userCommon.isMoveLeftPossible(shipDrag,-1)) {
                dragShip(0, -1);
            }
        } else {
            if (column > 0) column--;
    ...
    private void moveRight() {
        if (shipTaken) {
            if (userCommon.isMoveRightPossible(shipDrag,1)) {
                dragShip(0, 1);
            }
        } else {
    ...
    private void moveUp() {
        if (shipTaken) {
            if (userCommon.isMoveUpPossible(shipDrag,-1)) {
                dragShip(-1, 0);
            }
        } else {
            if (row > 0) row--;
    ...
    private void moveDown() {
        if (shipTaken) {
            if (userCommon.isMoveDownPossible(shipDrag,1)) {
                dragShip(1, 0);
            }
        } else {
